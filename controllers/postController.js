...
const {user_posts, all_posts, get_post, get_following_posts, create_post, delete_post, update_post } = require("../prisma/postQuery");
const { body } = require("express-validator");
const { upsert_tags } = require("../prisma/tagQuery");
const prisma = new PrismaClient();
const validationHandle = require("../middleware/validationHandle")


module.exports.getManyPosts = asyncHandler(async(req,res,next)=>{
...
module.exports.getFollowingPosts = asyncHandler(async(req,res,next)=>{
...
/**
 * STAGES:
 * 1. create posts without and attachments first
 *  FIELDS
 *  - gitLink
 *  - repoLink
 *  - userId
 *  - body
 *  - tags
 * 2. Set up multer and cloudinary first in order to handle media
 * 
 */
