...
const { get_all_users, get_user_details, get_followers, delete_user } = require("../prisma/userQuery");
...
exports.followUser = asyncHandler(async(req,res,next) => {
    ...
    2. If the record exist, not sure to throw an error or not. i guess not 
    3. To avoid throwing an Error, use deleteMany()
    */
